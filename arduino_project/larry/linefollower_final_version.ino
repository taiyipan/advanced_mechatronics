//////////////
///////////////////////////////////////////////////////////////////// final position not coded yet, other functions work well///////////////////////////////////////
...
//  Serial.println();
  ...
  if(sensorValues[5]>100 && sensorValues[4]>100 && sensorValues[3]>100 && sensorValues[2]>100 && sensorValues[1]>100 && sensorValues[0]>100 && count==1)
  {
  ...
  ///////////////// meet intersection 1~4, start detecting object//////////////////
  if(sensorValues[5]>100 && sensorValues[0]>100 && sensorValues[2]>100 && sensorValues[3]>100 && count>1 && count<5)
  {
...
if(sensorValues[5]>100 && sensorValues[0]>100 && sensorValues[2]>100 && sensorValues[3]>100 && count==5) 
  {
    Serial.print("Intersection Detected!");
    Serial.print('\t');
    servo_stop();
